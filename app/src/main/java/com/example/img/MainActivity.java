    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _btnCalculIMG.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                _lblResultat.setText("Votre IMG est " + resIMG+"%");

                if(_rdbHomme.isChecked()){
                    if(resIMG<25){
                        _lblInterpretation.setText("Vous êtes maigrichon");
                    }
                    else if (resIMG>25 && resIMG<31){
                        _lblInterpretation.setText("Vous êtes dans la norme");
                    }else {
                        _lblInterpretation.setText("Vous êtes trés gros, ATTENTION!!!!!");
                    }
                }else{
                    if(resIMG<15){
                        _lblInterpretation.setText("Vous êtes maigrichon");
